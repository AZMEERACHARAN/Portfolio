  ...
  return (
    <section id="testimonials" className="py-32 relative overflow-hidden">
      ...
      <div className="relative w-full flex overflow-hidden">
        ...
        <div className="absolute left-0 top-0 bottom-0 w-24 sm:w-48 bg-gradient-to-r from-[#030308] to-transparent z-10" />
        <div className="absolute right-0 top-0 bottom-0 w-24 sm:w-48 bg-gradient-to-l from-[#030308] to-transparent z-10" />
